...
# Free-tier friendly Decision Tree for census income prediction.
# Designed to keep memory low: row limit, compact categorical encoding, shallow tree.
...
dbutils.widgets.text("experiment_name", "/Shared/census_free_tier_decision_tree")
...
with mlflow.start_run(run_name="free_tier_decision_tree"):
